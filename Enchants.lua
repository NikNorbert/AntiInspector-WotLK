...
-- Complete English enchant-name table generated from the enUS
-- SpellItemEnchantment.dbc shipped with the local WoW 3.3.5a client.
-- Named records: 2655 of 2656.
AntiInspector.EnchantFallbacks = {
    [1] = "Rockbiter 3",
    [2] = "Frostbrand 1",
    [3] = "Flametongue 3",
    [4] = "Flametongue 2",
